export function SectionHeading({ title, subtitle, highlight }: { title: string; subtitle: string; highlight: string }) {
  return (
    <div className="lui-heading">
      <div className="container">
        <div className="m-titles align-center">
          <h2 className="m-title scroll-animate animate__active" data-animate="active">
            <span> {title} </span>
          </h2>
          <div className="m-subtitle scroll-animate animate__active" data-animate="active">
            <span>
              {subtitle} <b>{highlight}</b>
            </span>
          </div>
        </div>
      </div>
